...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameHubApi.ListGamesRequest();
  });
  ...
  describe('ListGamesRequest', function() {
    it('should create an instance of ListGamesRequest', function() {
      // uncomment below and update the code to test ListGamesRequest
      //var instance = new GameHubApi.ListGamesRequest();
      //expect(instance).to.be.a(GameHubApi.ListGamesRequest);
    });
    ...
    it('should have the property producerId (base name: "producer_id")', function() {
