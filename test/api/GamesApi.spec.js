...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameHubApi.GamesApi();
  });
  ...
  describe('GamesApi', function() {
    describe('getApiV1GamesId', function() {
      it('should call getApiV1GamesId successfully', function(done) {
        //uncomment below and update the code to test getApiV1GamesId
        //instance.getApiV1GamesId(function(error) {
